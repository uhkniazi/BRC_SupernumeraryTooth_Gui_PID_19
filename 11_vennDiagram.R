...
venn.diagram(lVenn[c(1, 3, 6)], filename = 'results/venn_all_contrasts_MutVsWT.tif', margin=0.1)
venn.diagram(lVenn[c(2, 4, 5)], filename = 'results/venn_all_contrasts_MutTime.tif', margin=0.1)
venn.diagram(lVenn[c(7, 8, 9)], filename = 'results/venn_all_contrasts_WTTime.tif', margin=0.1)
