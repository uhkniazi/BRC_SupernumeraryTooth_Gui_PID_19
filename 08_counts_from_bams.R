...
where (Sample.idData = 39) AND (File.idSample = Sample.id AND File.type like "%duplicates removed%")')
...
# setwd(gcswd)
# n = make.names(paste('lCounts rd did 39 gui rds'))
...
#                 comment='list of Count matrix from gui mouse tooth project with quality 10 and duplicates removed')
